...
\subsection{Reworking the model}
...
Finally I reach a model which still doesn't match perfectly the lithography but is the one that please me the most until now.\\
...
The red line is here to mark the limit of the quarter which is repeated to help debug the model.\\
