...
Lets also define names for the platforms and stairs.\\

\begin{center}
\begin{figure}[H]
\centering\includegraphics[height=10cm]{./platformsName.png}
\centering\includegraphics[height=10cm]{./stairsName.png}\\
\end{figure}
\end{center}
